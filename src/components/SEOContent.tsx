        ...
        <div className="container mx-auto px-4">
          <motion.div {...fadeUp} className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
              Start Your <span className="text-gradient-primary">Fast Learning Journey</span> Today
            </h2>
            <p className="text-lg text-muted-foreground mb-8">
              Join thousands already using Smart Mind to learn faster online. 
              Experience AI-powered personalized learning—completely free to start.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/learn">
                <Button size="xl" className="gap-2 w-full sm:w-auto gradient-primary text-primary-foreground glow-cyan hover:scale-105 transition-transform">
                  Get Started Free
                  <ArrowRight className="h-5 w-5" />
                </Button>
              </Link>
              <Link to="/quiz">
                <Button size="xl" className="gap-2 w-full sm:w-auto glass border-primary/20 text-foreground hover:border-primary/40 hover:scale-105 transition-all">
