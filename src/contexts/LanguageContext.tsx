...
const translations: Translations = {
  ...
  // Hero
  'hero.badge': {
    en: '🧠 AI-Powered Learning & Productivity',
    fr: '🧠 Apprentissage et Productivité par IA',
    rw: '🧠 Kwiga no Gukora na AI',
    sw: '🧠 Kujifunza na Tija kwa AI',
  },
  'hero.title': {
    en: 'Think Smarter with',
    fr: 'Pensez Plus Intelligemment avec',
    rw: 'Tekereza Neza na',
    sw: 'Fikiri kwa Akili na',
  },
  'hero.titleAccent': {
    en: 'Smart Mind',
    fr: 'Smart Mind',
  ...
  'hero.subtitle': {
    en: 'Boost your focus, accelerate learning, and sharpen decision-making. Smart Mind is the AI productivity app that helps you unlock peak mental performance—instantly.',
    fr: 'Améliorez votre concentration, accélérez l\'apprentissage et affinez votre prise de décision. Smart Mind est l\'application IA qui libère vos performances mentales.',
    rw: 'Ongerera imbaraga, wige byihuse, kandi ufate ibyemezo byiza. Smart Mind ni porogaramu ya AI ikugirira umumaro.',
    sw: 'Boresha umakini wako, harakisha kujifunza, na kuimarisha maamuzi. Smart Mind ni programu ya AI inayokusaidia kufikia utendaji wa juu wa akili.',
  },
  'hero.cta': {
    en: 'Get Started Free',
  ...
  'hero.ctaSecondary': {
    en: 'Test Your Brain',
    fr: 'Testez Votre Cerveau',
    rw: 'Gerageza Ubwonko',
    sw: 'Jaribu Ubongo Wako',
  },
  // Features
  'features.title': {
